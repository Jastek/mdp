...
router.get('/chapters', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const count = yield chapter_1.Chapter.count(search);
        const data = yield chapter_1.Chapter.find(search).sort(order).limit(limit).skip(offset);
 ...
 * List all paginated
 */
router.get('/chapters/all', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield chapter_1.Chapter.find({});
...
router.get('/chapters/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const data = yield chapter_1.Chapter.findById(id);
        res.status(200).send(api_response_1.ApiResponse.buildSuccess(data));
    }
    catch (err) {
        res.status(500).send(api_response_1.ApiResponse.buildError(err));
 ...
 */
router.get('/chapters/:id/people', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = req.params.id;
        if (!id)
            res.status(400).send(api_response_1.ApiResponse.buildError("Not authorized"));
        ...
        const data = yield person_1.Person.find({
            'chapter': new mongodb_1.ObjectId(id)
        })
...
router.post('/chapters', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield chapter.save();
 ...
 * Update
 */
router.patch('/chapters/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (!req.user.isAdmin)
            return res.status(401).send('Not Authorized');
        const id = req.params.id;
        ...
        const result = yield chapter_1.Chapter.findByIdAndUpdate(id, updateData);
        res.status(200).send(api_response_1.ApiResponse.buildSuccess(result));
    }
    catch (err) {
        // tslint:disable-next-line:no-console
...
router.delete('/chapters/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!id)
            res.status(400).send(api_response_1.ApiResponse.buildError("Not authorized"));
        const person = yield chapter_1.Chapter.findByIdAndDelete(id);
